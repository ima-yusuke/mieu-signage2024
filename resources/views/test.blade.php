...
<head>
    ...
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        @vite(['resources/css/app.css', 'resources/css/category.css', 'resources/css/content.css','resources/css/loading.css',
        'resources/js/app.js','resources/js/main.js','resources/js/screen-size.js','resources/js/particle.js','resources/js/loading.js'])
    @else
        <style>
