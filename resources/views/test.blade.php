...
<head>
    ...
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        @vite(['resources/css/app.css', 'resources/css/category.css', 'resources/css/content.css',
        'resources/js/app.js','resources/js/main.js','resources/js/screen-size.js','resources/js/particle.js'])
    @else
        <style>
...
<!-- 学部メニュー -->
<section class="flex justify-center items-center h-full w-full" id="category_container">
    {{--スライド--}}
